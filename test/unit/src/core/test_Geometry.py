...
class TestGeometry( unittest.TestCase ):
    ...
    def test_fromBufferGeometry( self ):
        ...
        bufferGeometry.addAttribute("position", THREE.BufferAttribute( ctypesArray( "f", [1, 2, 3, 4, 5, 6, 7, 8, 9] ), 3 ) )
        bufferGeometry.addAttribute("color", THREE.BufferAttribute( ctypesArray( "f", [0, 0, 0, 0.5, 0.5, 0.5, 1, 1, 1] ), 3 ) )
        bufferGeometry.addAttribute("normal", THREE.BufferAttribute( ctypesArray( "f", [0, 1, 0, 1, 0, 1, 1, 1, 0] ), 3 ) )
        bufferGeometry.addAttribute("uv", THREE.BufferAttribute( ctypesArray( "f", [0, 0, 0, 1, 1, 1] ), 2 ) )
        bufferGeometry.addAttribute("uv2", THREE.BufferAttribute( ctypesArray( "f", [0, 0, 0, 1, 1, 1] ), 2 ) )
